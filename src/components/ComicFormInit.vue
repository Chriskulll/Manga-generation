...
<template>
  <el-form class="form" :model="form" label-width="auto" >
    ...
    <div class="text-wrapper">
      ...
      <el-form-item>
        <el-input class="input1" v-model="form.plotoutline" type="textarea" :rows="3"/>
      </el-form-item>
      <el-button class="button1">剧情扩写</el-button>
    </div>
    <!--        详细脚本-->
    <div class="text-wrapper">
      ...
      <el-form-item>
        <el-input class="input1" v-model="form.plotdetail" type="textarea" :rows="3"/>
      </el-form-item>
